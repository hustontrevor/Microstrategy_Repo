...
CASE O.OBJECT_TYPE		
	...
	WHEN 47 THEN 'Consoloidations'	
	WHEN 52 THEN 'Link'	
	WHEN 53 THEN 'Warehouse Table'	
	WHEN 55 THEN 'Document'	
	WHEN 56 THEN 'Drill Map'	
	WHEN 58 THEN 'Security Filter'	
	WHEN 60 THEN 'Answer'	
	WHEN 61 THEN 'Graph Style'	
	WHEN 71 THEN 'Palette'	
	ELSE 'OTHERS'	
END AS [OBJECT TYPE]		
...
,CASE WHEN o.SS_OBJECT_NAME <> '' THEN o.SS_OBJECT_NAME ELSE o.OBJECT_NAME END [SS OBJECT NAME]
...
(SELECT 'Base Objects' oSOURCE		
	...
	,o.DESCRIPTION SS_DESCRIPTION,o.OBJECT_TYPE SS_OBJECT_TYPE ,o.SUBTYPE SS_SUBTYPE	
	FROM DSSMDOBJINFO o	
